...
########## Hists I added
        'ht_atlas'         : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("ht_atlas",      "H$_{T}$ ATLAS (GeV)", 6, 190, 340)),
...
########################################################################################################                   Up to here the cut thing
              ...
              cut_metg25 = (cutnomet) & GetCutJets(['metg25'], syst, mtw, njets_var, nbtags_var)   # de aqui
              cut_metl25 = (cutnomet) & GetCutJets(['metl25'], syst, mtw, njets_var, nbtags_var)
              cut_metg20 = (cutnomet) & GetCutJets(['metg20'], syst, mtw, njets_var, nbtags_var)
              cut_metl20 = (cutnomet) & GetCutJets(['metl20'], syst, mtw, njets_var, nbtags_var)
