...
if __name__=="__main__":
  ...
  outpath = 'QCD_withmtw/Control_Plots/'#baseweb+datatoday+'/ControlPlots_nodata/'
  print('[Control plots] Output = ', outpath)
  if not os.path.isdir(outpath): os.makedirs(outpath)
  plt.SetOutpath(outpath)

  # Analysis var
  variables_control =['mtw','met', 'ht', 'mt', 'j0eta', 'j0pt', 'ept', 'eeta', 'mpt', 'meta','ht_atlas','mlb','met_mtw']
  ...
  systematics = ['ISR', 'FSR','btagSF', 'elecSF', 'muonSF', 'prefire','JER','MC', 'AbsStat', 'AbsScale', 'AbsMPF', 'Frag', 'ECAL', 'HCAL', 'Flavor', 'RelStat', 'RelPt', 'RelBal', 'RelJER', 'L3Res','MET_UnclusteredEnergy']#
